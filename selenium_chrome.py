...
driver.find_elements_by_xpath("//input[@name='username']")[0].send_keys('your_username')
driver.find_elements_by_xpath("//input[@name='password']")[0].send_keys('your_password')
